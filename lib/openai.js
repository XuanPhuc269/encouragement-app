export async function generateMessage({ name, score, feeling }) {
    const prompt = `
        ...
        *Yêu cầu nội dung*:
        1. Gọi học sinh là “em”, và người gửi (tôi) là "anh" tên là Xuân Phúc. Lưu ý chỉ gọi ${name} phần TÊN, không gọi HỌ của học sinh.
        2. Lời nhắn cần có **3 đoạn rõ ràng**:
        - **Đoạn 1**: Chúc mừng học sinh đã nỗ lực trong suốt thời gian qua. Viết ít nhất 3 câu để thể hiện sự công nhận và khích lệ
